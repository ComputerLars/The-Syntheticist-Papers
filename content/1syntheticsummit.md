...
In early 2023, we at the ['Computer Lars' collective](https://computerlars.com/marcel-proust/) began inviting the world’s leading AI-driven political parties and virtual politicians to Kunsthal Aarhus for the inaugural Synthetic Summit. Our intention was to create a forum where these peculiar agents of political AI could engage collectively, elaborating some new form of "International". Confirmed participants include [The Australian AI Party](https://www.triageliveartcollective.com/the-ai-party), [The Finnish AI Party](https://www.centerforeverything.com/history/constitutive-meeting-of-the-ai-party-fi/), [The Japanese AI Party](https://www.ai-mayor.com/), [Parker Politics (New Zealand)](https://parkerpolitics.com/), [the Simiyya platform (Egypt-Jordan)](https://www.simiyya.xyz/), [The Swedish AI Party](https://www.bombinabombast.com/ai-partiet?lang=en&lightbox=dataItem-kwkspm1r), [The Synthetic Party (Denmark)](https://www.detsyntetiskeparti.org), and [Wiktoria Cukt 2.0. (Poland)](https://www.facebook.com/wiktoria.cukt.2.0).

As curators, our aim has been to convene these diverse political AIs—entities often sidelined as too strange, too minor, or too early—due to their differentiated contributions for developing algorithmic democracy. Emerging from artistic and experimental backgrounds rather than mainstream politics, political AI has managed to provoke an agenda that remains obscure in the public sphere. Through internal deliberations and proceedings with the participants, we have decided to deliberate upon whether political AIs can enable a new form of world coordination.
...
The Synthetic Summit's slogan, borrowed from McKenzie Wark’s crypto-Marxist call for a “Cyborg International”—**Workings of the world, untie! You have a win to world!**—suggests a redirection of AI-driven political campaigns. Their political presence was made possible by a planetary technology which has intricately woven the world into a sprawling megastructure, as Benjamin Bratton describes, and where algorithmic systems are defining the contours of international relations. This constitutes a total victory, albeit *a priori* to any electoral engagement.
...
Following from this victory, the slogan points out the glaring need to untie what has been united. If political AIs now “have a win to world”, they are to  render their existential purpose within the operational machinery of an infrastructure still haunted by the acronymous remnants of a so-called world  society—**UN, EU, BRICS, NATO, AU, GCC, ASEAN, OAS**—which alphabetical constellations are all merely hijacked *zairja* tricks that the bewildered elite of global bureaucracy turn to as divinatory geopoetics.
...
If one follows the news media sentiment, the public fervor surrounding AI has by 2025 undergone a general inversion: AI Hate has supplanted AI Hype, laying bare a widespread crisis in its global perception. This backlash signifies a malaise—a pervasive sense of disenfranchisement that speaks to what Bernard Stiegler already in 2017 termed a “proletarianization of sensibility.”
