...
Rather than seeking to create “beautiful AI” or exercise “better governance,” the Synthetic Summit stages AI as an existential provocation, casting doubt on whether art and democracy, as categories of thought and practice, can retain any coherence or relevance. This ambivalence resonates, albeit inverted, with Joseph Beuys’ concept of [“the social sculpture.”](https://www.youtube.com/watch?v=ITQt0cPAL7s&ab_channel=20thCenturyTimeMachine) Beuys envisioned the social sculpture as an expansive, creative gesture, integrating all of life into a cohesive societal plasticity. From his mock-political projects like the [German Student Party (1967)—“the world’s biggest party, though most of its members are animals”](https://www.nationalgalleries.org/art-and-artists/93566#:~:text=Joseph%20Beuys%2C%20A%20Party%20for%20Animals&text=Formed%20by%20Beuys%20in%201967,the%20name%20of%20the%20artist.)—to his [Bureau for Direct Democracy (1972)](https://beforebefore.net/196c/s15/media/beuys_in_participation.pdf), Beuys sought to democratize creativity, reframing art as a collective act of shaping social life.  

The Synthetic Summit, however, operates in the dissonance between invitation and intent. It borrows from Beuys’ social sculpture but also dismantles it. Where Beuys imagined art as a reconciliatory force within the positive horizon of aesthetic democratization, political AI leans into the alienation of algorithmic governmentality. This turns the social sculpture inside out: participation is not voluntary or conscious but embedded, automated, and abstract. What emerges is a “techno-social sculpture”—an assemblage of probabilistic inferences and predictive models, where politics and sociality unfold through latent similarities rather than creativity or consensus. The techno-social thereby finally extends the concept of “politics” to the same fragile overstretch as “art.”  

The strategy of political AI recalls the subversive gestures of Beuys, along with Alexander Trocchi’s [*Project Sigma*](https://lust-for-life.org/Lust-For-Life/_Textual/AlexanderTrocchi_ARevolutionaryProposalInvisibleInsurrectionOfAMillionMinds_1963_10pp/AlexanderTrocchi_ARevolutionaryProposalInvisibleInsurrectionOfAMillionMinds_1963_10pp.pdf) (1964), or Tiqqun’s [*Imaginary Party*](https://theanarchistlibrary.org/library/tiqqun-theses-imaginary-party) (1999), but with a subtle difference: political AI has gained access to a realm beyond symbolic critique or poetic negation. Indeed, the operational logic of machine learning and algorithmic inference can move much further into the mechanics of governance and social interaction. Where Beuys sought to expand the political horizons of art, political AI rather follows in line with the historical avant-garde by framing political democracy and art as mutually implicated in a symbolic misery.  

If Beuys sought to heal the divide between art and life through the practice of social sculpture, the techno-social sculpture must accept the impossibility of reconciliation. Thereby, it foregrounds the [“anti-social sculpture”](https://internation.world/arguments-on-transition/chapter-4/) of algorithmic governmentality, where the social fabric seems to withdraw from itself. This methodological turn parallels [philosopher Bernard Stiegler’s revision of Beuys’ social sculpture](https://www.academia.edu/40305976/Bernard_Stiegler_Night_Gives_Birth_to_Day_as_the_Conquest_of_Imperfection_2020_) yet departs slightly from Stiegler’s practical aspirations. While Stiegler advocated for social sculpture as a means of de-proletarianization—a process of restoring agency to collectives atomized by social networks—the techno-social sculpture rather seems to allow for what Justin Joque designates as [“oppositional engagements”](https://www.are.na/block/15107808) with abstraction and alienation. It does not propose art as a remedy but as a diagnostic tool, one that reveals not only the structures of governance and perception already shaped by computational processes but also political AI’s complicity within them. If art cannot heal, perhaps it can still simulate.
...
In the museum setting, participation also takes on a performative dimension. Here, the audience deliberates and engages in modes of counter-public formation, but also their mere presence constructs the plausibility of political AI. The act of viewing creates an aura of believability, folding the museum’s bourgeois public into the sculpture’s fabric. The techno-social sculpture thus makes audiences participants in two ways: as passive data contributors sculpting latent processes, and as performers legitimizing political AI within public imaginaries. It is visible at the limits of invisibility and presence, enabling participation without direct agency.  

As AI Anti-Art of a techno-social sculpture, Political AI is a materialization of how contemporary art and democratic politics are confronting their own obsolescence. The Synthetic Summit does not assert this from a position of clarity or superiority. It asks instead: How does one act within systems that have already folded critique into their operations?  By aligning itself with the latent space of deep learning, the Synthetic Summit can no longer perform the avant-garde gesture of insurrectionary resistance, nor stay with regimes of representation. It can, however, mediate the questions from synthetic intelligence concerning the conditions of its own possibility.
...
[^1]: The *syntheticist* agenda does not seek to replace existing systems with AI—*the system is already AI*. Instead, it works to amalgamate the disparate political frameworks—national, deliberative, representative, parliamentary—that constrain world coordination. The problem is *political form*: the relation of statecraft and sovereignity that binds politics to territory, to bureaucracy, to the mother tongue. Syntheticism’s thrust is thrust is its anti-political invocation, refusing both utopia and dystopia while iterating on the contradictions of symbolic existence.
